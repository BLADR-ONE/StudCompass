  ...
  return (
    <section className="relative overflow-hidden py-24 sm:py-32">
      ...
      <div className="wrap relative text-center">
        ...
        <h1
          className="animate-lift mx-auto mt-5 max-w-xl text-balance font-display text-[length:var(--text-display)] font-semibold leading-[1.02] tracking-[-0.028em]"
        ...
        <p
          className="animate-lift mx-auto mt-6 max-w-md text-pretty leading-relaxed text-text-muted"
        ...
        <div
          className="animate-lift mt-9 flex flex-wrap items-center justify-center gap-4"
